 ...
 */
export type AttributeHandler<O extends SaxesOptions> = (attribute: AttributeEventForOptions<O>) => void;
/**
 ...
 */
export type SaxesTagPlain = Pick<SaxesTag, "name" | "attributes" | "isSelfClosing"> & {
...
export type TagForOptions<O extends SaxesOptions> = O extends {
    xmlns: true;
} ? SaxesTagNS : O extends {
    xmlns?: false | undefined;
} ? SaxesTagPlain : SaxesTag;
export type StartTagForOptions<O extends SaxesOptions> = O extends {
    xmlns: true;
