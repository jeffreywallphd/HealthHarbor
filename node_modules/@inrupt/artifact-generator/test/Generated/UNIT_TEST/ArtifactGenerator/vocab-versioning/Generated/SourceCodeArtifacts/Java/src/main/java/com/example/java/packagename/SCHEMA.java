 ...
 * as part of artifact: [myNewArtifact], version: [0.1.0]
 * on 'Monday, October 2, 2023 11:19 AM'.
 *
 * Vocabulary built from vocab list file: [./test/resources/versioning/vocab-list.yml].
 ...
 *  - Constant strings: [0]
 *
 * [Generator provided] - An example vocabulary
 */
