 ...
 * as part of artifact: [generated-vocab-TEST], version: [99.99.99]
 * on 'Monday, October 2, 2023 11:19 AM'.
 *
 * Vocabulary built from vocab list file: [./test/resources/yamlConfig/vocab-license.yml].
...
import type { NamedNode as _NamedNode, DataFactory as _DataFactoryType } from '@rdfjs/types/data-model'
import { DataFactory as _DataFactoryImpl } from 'rdf-data-factory';

const _rdfFactory: _DataFactoryType = new _DataFactoryImpl();

function _NS(localName: string): _NamedNode {
  return _rdfFactory.namedNode(`https://schema.org/${localName}`);
}
...
const SCHEMA_INRUPT_EXT = {
  ...
  Person: new _VocabTerm(
    ...
    .addType(_rdfFactory.namedNode("http://www.w3.org/2000/01/rdf-schema#Class"))
  ...
  givenName: new _VocabTerm(
    ...
    .addType(_rdfFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#Property"))
