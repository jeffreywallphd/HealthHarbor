...
router.get('/retrieveincomeall', async (req, res) => {
    try {
...
router.get('/searchincome', async (req, res) => {
    try {
...
router.put('/updateincomerecord', async (req, res) => {
    try {
...
router.delete('/deleteincomerecord', async (req, res) => {
    try {
