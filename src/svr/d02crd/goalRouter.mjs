...
async function saveGoalData(goalID, userID, name, amount, deadline) {
    ...
    //console.log("Arguments passed +++" + goalID + "---" + userID + "---" + name + "---" + amount + "---" + deadline)
    let myPod;
...
router.post('/savegoal', async (req, res) => {
    ...
    const { goalID, userID, name, amount, goalDate } = req.body;
    console.log("Params ++++++ ", goalID, userID, name, amount, goalDate);
    try {
        await saveGoalData(goalID, userID, name, amount, goalDate);
...
router.get('/retrievegoalall', async (req, res) => {
    try {
...
router.get('/searchgoal', async (req, res) => {
    try {
...
router.put('/updategoalrecord', async (req, res) => {
    try {
...
router.delete('/deletegoalrecord', async (req, res) => {
    try {
