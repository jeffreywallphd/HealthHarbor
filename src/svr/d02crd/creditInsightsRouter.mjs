...
router.post('/savecreditinsight', async (req, res) => {
...
router.get('/retrievecreditinsightall', async (req, res) => {
    try {
...
router.get('/searchcreditinsight', async (req, res) => {
    try {
...
router.put('/updatecreditinsightrecord', async (req, res) => {
    try {
...
router.delete('/deletecreditinsightrecord', async (req, res) => {
    try {
