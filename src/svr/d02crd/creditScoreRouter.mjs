...
router.post('/savecreditscore', async (req, res) => {
...
router.get('/retrievecreditscoreall', async (req, res) => {
    try {
...
router.get('/searchcreditscore', async (req, res) => {
    try {
...
router.put('/updatecreditscorerecord', async (req, res) => {
    try {
...
router.delete('/deletecreditscorerecord', async (req, res) => {
    try {
