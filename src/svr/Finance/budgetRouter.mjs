...
router.get('/retrieveBudgetAll', async (req, res) => {
    try {
...
router.get('/searchBudget', async (req, res) => {
    try {
...
router.put('/updateBudgetRecord', async (req, res) => {
    try {
...
router.delete('/deleteBudgetRecord', async (req, res) => {
    try {
