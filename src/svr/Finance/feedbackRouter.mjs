...
router.get('/retrievefeedbackall', async (req, res) => {
    try {
...
router.get('/searchfeedback', async (req, res) => {
    try {
...
router.put('/updatefeedbackrecord', async (req, res) => {
    try {
...
router.delete('/deletefeedbackrecord', async (req, res) => {
    try {
