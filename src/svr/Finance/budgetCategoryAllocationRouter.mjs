...
router.post('/savebudgetcategoryallocation', async (req, res) => {
...
router.get('/retrievebudgetcategoryallocationall', async (req, res) => {
    try {
...
router.get('/searchbudgetcategoryallocation', async (req, res) => {
    try {
...
router.put('/updatebudgetcategoryallocationrecord', async (req, res) => {
    try {
...
router.delete('/deletebudgetcategoryallocationrecord', async (req, res) => {
    try {
