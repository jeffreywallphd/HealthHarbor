...
app.get('/retrievecategoryall', async (req, res) => {
    try {
...
app.put('/updatecategoryrecord', async (req, res) => {
    try {
...
app.delete('/deletecategoryrecord', async (req, res) => {
    try {
