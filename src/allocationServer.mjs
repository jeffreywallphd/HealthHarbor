...
app.post('/saveallocation', async (req, res) => {
...
app.get('/retrieveallocationall', async (req, res) => {
    try {
...
app.get('/searchallocation', async (req, res) => {
    try {
...
app.put('/updateallocationrecord', async (req, res) => {
    try {
...
app.delete('/deleteallocationrecord', async (req, res) => {
    try {
