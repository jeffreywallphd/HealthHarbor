...
app.get('/retrieveexpenseall', async (req, res) => {
    try {
...
app.get('/searchexpense', async (req, res) => {
    try {
...
app.put('/updateexpenserecord', async (req, res) => {
    try {
...
app.delete('/deleteexpenserecord', async (req, res) => {
    try {
